...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Cursor resultSet = db.rawQuery("Select EMAIL,PASSWORD from "+InClassDatabaseHelper.TABLE_NAME+" where EMAIL='" + mEmail +"'",null);
            ...
            if (!email.equalsIgnoreCase("") && email.equals(mEmail)) {
                // Account exists, return true if the password matches.
                if (!password.equalsIgnoreCase("") && password.equals(mPassword)){
                    return true;
                }
                else{
                    incorrectPass = true;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent yourIntent = new Intent(LoginActivity.this,CalculateBMI.class);
                Bundle b = new Bundle();
